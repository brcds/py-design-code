...
class Calculator1:
    ...
    def calculate(self, request: FlaskRequest):
        ...
        secund_process_result = self.__second_process(splited_number)
        calc_result = first_process_result + secund_process_result + splited_number
